...
interface SchemaCreationModalProps {
  onClose: () => void;
  onSaveSchema: (schemaDetails: WeaviateSchemaDetails) => void;
}
...
{ dataType: WeaviateDataType.TEXT, description: '', name: '' },
{ dataType: WeaviateDataType.TEXT ,description: '', name: '' },
{ dataType: WeaviateDataType.TEXT, description: '', name: '' },
]);
...
const schemaDetails: WeaviateSchemaDetails = {
class: className,
...
const updateProperty = (index: number, field: keyof WeaviateProperty, value: string) => {
